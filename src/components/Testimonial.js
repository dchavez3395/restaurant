...
const Testimonial = () => {
  ...
  return (
    <section className='bg-testimonial bg-cover bg-no-repeat relative z-10 h-[800px] top-[340px] lg:top-[390px] pt-[60px] md:pt-[120px]'>
      <div className='mx-auto container'>
        ...
        {/* slider */}
        <motion.div variants={fadeIn('up', 'tween', 0.4, 1.6)} initial='hidden' whileInView={'show'} className='items-center justify-center flex'>
